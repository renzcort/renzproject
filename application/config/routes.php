...
/*Entries*/
$route['admin/section/(:num)/(:any)']         = 'admin/section/entrytypes/$1';
$route['admin/section/(:num)/(:any)/(:any)']  = 'admin/section/entrytypes_create/$1';
$route['admin/section/(:num)/(:any)/(:num)']  = 'admin/section/entrytypes_update/$1/$2';

      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <div class="d-flex flex-column justify-content-start align-items-center">
            ...
            <h5 class="footer text-center font-weight-light"><a href="#">See All Messages</a></h5>
          </div>
        </div>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <div class="d-flex flex-column flex-wrap justify-content-start">
            <h5 class="header">You have 4 messages</h5>
            <div class="content overflow-auto">
              <div class="dropdown-item d-flex flex-row justify-content-start align-content-center align-items-center">

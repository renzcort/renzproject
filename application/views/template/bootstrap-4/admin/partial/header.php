...
<div class="container title d-flex flex-row flex-wrap justify-content-between align-items-center">
  ...
  <?php if (isset($button)): ?>
    <div class="d-flex flex-row flex-wrap justify-content-start">
      <a href="#" id="buttonHeader" class="btn btn-danger btn-sm mx-1" type="<?php echo (isset($button_type) ? $button_type : '') ?>" name="<?php echo (isset($button_name) ? $button_name : ''); ?>"><?php echo ucfirst($button);?></a>
